...
class Login extends React.Component {
    ...
    render() {
      ...
      <h1
        ...
        <TextField inputProps={{ className: styles.input, pattern: "^[a-zA-Z0-9]*$" }} onChange={this.handleChange} sx={styles.field} style={{width: "340px", border: "2.5px solid #C4C4C4"}} label="" name="password" />
        </div>
      </header>
